package com.hexa.muinus.store.domain.repository;

import com.hexa.muinus.store.domain.Store;
import com.hexa.muinus.store.domain.dto.StoreDTO;
...
public interface StoreRepository extends JpaRepository<Store, Integer> {
    ...
    @Query(value = """
            SELECT new com.hexa.muinus.store.domain.dto.StoreSearchDTO(
    ...
    @Query("""
        SELECT new com.hexa.muinus.store.domain.dto.StoreDTO(
